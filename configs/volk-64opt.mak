...
#F90 = ifort -warn -fast -complex_limited_range -debug extended -traceback
F90 = ifort -warn -fast -openmp -assume cc_omp -complex_limited_range -debug extended -traceback
F90L = $(F90)
